...
def main():
    ...
    parser.add_argument(
        "--parquet-dir",
        default=str(script_dir / "../ingestion/parquet_files"),
    ...
    parser.add_argument(
        "--document-csv",
        default=str(script_dir / "../ingestion/document_info.csv"),
        help="Path to document info CSV file for metadata (default: ../ingestion/document_info.csv)"
    )
    parser.add_argument(
        "--sir-summaries-csv",
        default=str(script_dir / "../llm_analysis/sir_summaries.csv"),
        help="Path to SIR summaries CSV file (default: ../llm_analysis/sir_summaries.csv)"
    )
    parser.add_argument(
        "--sir-violation-levels-csv",
        default=str(script_dir / "../llm_analysis/sir_violation_levels.csv"),
        help="Path to SIR violation levels CSV file (default: ../llm_analysis/sir_violation_levels.csv)"
    )
    parser.add_argument(
        "--keyword-reduction-csv",
        default=str(script_dir / "../llm_analysis/violation_curation_keyword_reduction.csv"),
        help="Path to keyword reduction CSV file (default: ../llm_analysis/violation_curation_keyword_reduction.csv)"
    )
    parser.add_argument(
        "--staffing-summaries-csv",
        default=str(script_dir / "../llm_analysis/staffing_summaries.csv"),
        help="Path to staffing summaries CSV file (default: ../llm_analysis/staffing_summaries.csv)"
    )
    parser.add_argument(
        "--verbose",
        action="store_true",
